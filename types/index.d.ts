...
declare class Neode {
	 ...
	 */
	batch(
		queries?: Array<{ query: string | object; params?: object | string }>,
	): Promise<any>;
	...
	hydrate<T>(
		res: QueryResult,
		alias: string,
		definition?: Neode.Model<T>,
	): Neode.NodeCollection;
...
declare namespace Neode {
	...
	interface RelationshipNodeProperties
		extends BaseRelationshipNodeProperties {
		type: "relationship";
	}
	...
	class Node<T> {
		...
		constructor(
			...
			model: Model<T>,
			node: Neo4jNode,
			eager?: Map<string, NodeCollection>,
		);
	...
	class NodeCollection {
		 ...
		 */
		map<U>(
			fn: (value: Node<any>, index: number, array: Array<Node<any>>) => U,
		): Array<U>;
